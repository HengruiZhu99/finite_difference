...
class cell{
 public:
  ...
  cell(int Ind, double Cent, int Nfields, std::vector<double> Vals, std::vector<int> Neighbors, std::vector<double> OutDir, std::vector<bool> IsInterior, std::vector<double> BdryLocation, std::vector<double> flowDirections);
...
class DataGrid{
 public:
  ...
  DataGrid(double x1, double x2, int N, bool periodic, int Nfields, std::vector<std::vector<double> > values, std::vector<double> flowDirection);
  ...
  std::vector<std::vector<double> > Dot(double dx, std::vector<double> (*f)(std::vector<double>), std::vector<double> (*s)(std::vector<double>));
